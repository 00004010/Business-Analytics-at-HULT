...
setwd("/Users/dosto/OneDrive/Desktop/HULT/HULT MSBA/Text Analytics/NLP Team Assignment/Harry Potter Survey/Harry Potter Survey")
nm <- list.files(path="/Users/dosto/OneDrive/Desktop/HULT/HULT MSBA/Text Analytics/NLP Team Assignment/Harry Potter Survey/Harry Potter Survey")
...
#Importing all .txt files from Harry Potter Survey # a txt works like a csv file with multiple rows
nm_2 <- list.files(path="/Users/dosto/OneDrive/Desktop/HULT/HULT MSBA/Text Analytics/NLP Team Assignment/Harry Potter Survey/Harry Potter Survey")
...
server <- function(input, output, session) ({
  ...
  output$team <- renderImage({
    filename <- normalizePath(file.path('/Users/dosto/OneDrive/Desktop/HULT/HULT MSBA/Text Analytics/team.jpeg'))
  ...
  output$hp <- renderImage({
    filename2 <- normalizePath(file.path('/Users/dosto/OneDrive/Desktop/HULT/HULT MSBA/Text Analytics/hp.jpeg'))
...
#-----------------------------------------------------------------------------#
  ...
  output$hp2 <- renderImage({
    filename3 <- normalizePath(file.path('/Users/dosto/OneDrive/Desktop/HULT/HULT MSBA/Text Analytics/hp.jpeg'))
